<template>
  ...
  >
    ...
    <div class="absolute inset-0 overflow-hidden">
      ...
      <div class="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-white/20 dark:to-black/30"></div>
      
      <!-- Floating light effects for hero -->
      <div class="absolute inset-0 opacity-50 dark:opacity-40">
        <div class="absolute top-1/4 left-1/4 w-64 h-64 bg-primary-300/25 dark:bg-primary-400/15 rounded-full blur-3xl animate-float-slow"></div>
        <div class="absolute top-3/4 right-1/4 w-48 h-48 bg-accent-300/30 dark:bg-accent-400/20 rounded-full blur-3xl animate-float-medium"></div>
        <div class="absolute top-1/2 right-1/3 w-32 h-32 bg-blue-200/35 dark:bg-blue-400/15 rounded-full blur-2xl animate-float-fast"></div>
      </div>
    </div>
    <!-- Content overlay -->
    <div class="section-container text-center relative z-10">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a 
                href="#projects" 
                class="btn-primary inline-block relative overflow-hidden group animate-pulse-glow"
              ...
              >
                ...
                <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out"></div>
              </a>
          <a
            :href="cvPdf"
            target="_blank"
          ...
          >
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-transparent via-primary-200/30 to-transparent -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out"></div>
          </a>
          <a 
            :href="cvPdf" 
            :download="`${translatedName} CV.pdf`"
          ...
          >
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-transparent via-green-200/30 to-transparent -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out"></div>
          </a>
        </div>
        ...
        <div class="mt-12 flex flex-wrap justify-center gap-6">
          <a 
            ...
            aria-label="GitHub"
          >
            <svg class="w-6 h-6 transition-transform duration-300 hover:animate-spin-slow" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a 
            ...
            aria-label="LinkedIn"
          >
            <svg class="w-6 h-6 transition-transform duration-300 hover:rotate-180" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a 
            ...
            aria-label="Facebook"
          >
            <svg class="w-6 h-6 transition-transform duration-300 hover:-rotate-12" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a 
            ...
            aria-label="TikTok"
          >
            <svg class="w-6 h-6 transition-transform duration-300 hover:rotate-45" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a 
            ...
            aria-label="YouTube"
          >
            <svg class="w-6 h-6 transition-transform duration-300 hover:-rotate-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a 
            ...
            aria-label="Email"
          >
            <svg class="w-6 h-6 transition-transform duration-300 hover:rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const viewProjectsLabel = computed(() => {
  const lang = currentLanguage.value
  return t('hero.viewProjects')
})
